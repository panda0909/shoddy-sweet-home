...
func _run() -> void:
	...
	var views := [
		...
		["living_coffee_table_close", Vector3(-5.25, 1.08, 3.05), Vector3(-6.12, 0.46, 3.35), 1],
		["living_fireplace_close", Vector3(-8.05, 1.28, 2.12), Vector3(-9.42, 0.78, 2.07), 1],
		...
		["kitchen_cooker_close", Vector3(6.25, 1.30, 4.10), Vector3(6.78, 0.74, 4.05), 1],
		["kitchen_table_close", Vector3(4.42, 1.24, 4.52), Vector3(5.41, 0.78, 4.74), 1],
		...
		["bedroom_bed_close", Vector3(-3.55, 1.40, -1.62), Vector3(-6.20, 0.92, -3.30), 1],
		...
		["bedroom_window_close", Vector3(-4.95, 1.48, -3.85), Vector3(-4.00, 1.78, -5.65), 1],
		...
		["bathroom_toilet_close", Vector3(5.85, 1.24, -4.75), Vector3(7.10, 0.72, -4.55), 1],
		["bathroom_tub_close", Vector3(4.58, 1.24, -3.38), Vector3(3.40, 0.48, -3.92), 1],
